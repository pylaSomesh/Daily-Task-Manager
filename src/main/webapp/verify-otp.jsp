...
if (resetEmail == null) resetEmail = (String) session.getAttribute("resetEmail");
...
<div class="page-wrapper">
    <div class="card">
        <div class="card-heading">
            ...
            <p style="font-size:13px;color:var(--text-secondary,#8b949e);margin-top:8px;">
                OTP expires in <%= expiryMinutes %> minutes.
            </p>
        </div>

        <form class="form" action="verifyOtp" method="POST">
            <div class="field">
        ...
        <form class="form" action="resendOtp" method="POST" style="margin-top:12px;">
            <button type="submit" class="btn-login" style="background:var(--bg-card,#1c2330);color:var(--text-primary,#e6edf3);box-shadow:none;border:1px solid var(--border,#30363d);">
                Resend OTP
            </button>
        </form>
